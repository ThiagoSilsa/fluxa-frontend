...
/**
 * Service de importação de veículos.
 * Responsável por toda comunicação com a API de importação de veículos.
 */
class VehiclesImportService {
  /**
   * Faz upload de um arquivo XLSX para importação de veículos.
   *
  ...
  /**
   * Lista os jobs de importação de veículos (histórico paginado).
   *
...
export const vehiclesImportService = new VehiclesImportService()
