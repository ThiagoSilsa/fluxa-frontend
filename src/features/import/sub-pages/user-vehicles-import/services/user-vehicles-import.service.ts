...
/**
 * Service de importação de vínculo usuário-veículo.
 * Responsável por toda comunicação com a API de importação de vínculos.
 */
class UserVehiclesImportService {
  /**
   * Faz upload de um arquivo XLSX para importação de vínculos usuário-veículo.
   *
  ...
  /**
   * Lista os jobs de importação de vínculos (histórico paginado).
   *
...
export const userVehiclesImportService = new UserVehiclesImportService()
